...
// ====================================================================================
// QUANTIZED TYPES - Proc Macro Based System
// ====================================================================================
// Import individual GGML quantization type wrappers
use crate::quantized::ggml_wrappers::*;

// Register all 12 GGML quantization types as separate QuantizedDType variants!
// Each gets its own enum variant, allowing users to specify exact quantization types.
// This generates:
//   - pub enum QuantizedDType { Q4_0, Q4_1, Q5_0, Q5_1, Q8_0, Q8_1, Q2K, Q3K, Q4K, Q5K, Q6K, Q8K }
//   - pub mod quantized_dispatch { dequantize_cpu, quantize_cpu, matmul_cpu, ... }
candle_quantized_macros::register_quantized_types!(
    Q4_0, Q4_1, Q5_0, Q5_1, Q8_0, Q8_1,
    Q2K, Q3K, Q4K, Q5K, Q6K, Q8K
);

// The macro above generates:
// - QuantizedDType enum with 12 variants (one per GGML type)
// - quantized_dispatch module with CPU/CUDA/Metal dispatch functions
// ====================================================================================
